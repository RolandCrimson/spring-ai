package com.adacho.ch08_embedding_vector_store.controller;
...
import com.adacho.ch08_embedding_vector_store.service.AiService;
import com.adacho.ch08_embedding_vector_store.service.FaceService;
...
public class AiController {
  ...
  @PostMapping(value = "/search-document-1", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE, produces = MediaType.TEXT_PLAIN_VALUE)
  public String searchDocument1(@RequestParam String question) {
  ...
  @PostMapping(value = "/search-document-2", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE, produces = MediaType.TEXT_PLAIN_VALUE)
  public String searchDocument2(@RequestParam String question) {
