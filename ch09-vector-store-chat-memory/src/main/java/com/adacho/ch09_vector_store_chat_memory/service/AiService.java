package com.adacho.ch09_vector_store_chat_memory.service;
...
public class AiService {
  ...
  // ##### 생성자 #####
  public AiService(JdbcTemplate jdbcTemplate, EmbeddingModel embeddingModel, ChatClient.Builder chatClientBuilder) {
